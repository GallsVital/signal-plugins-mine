...
export function Name() { return "Razer Mouse Dock"; }
export function VendorId() { return 0x1532; }
export function Documentation(){ return "troubleshooting/razer"; }
export function ProductId() { return 0x007e; }
...
const vLedNames = ["Dock"];
const vLedPositions = [[3, 3]];
...
export function ImageUrl(){
	return "https://marketplace.signalrgb.com/devices/brands/razer/mice/mouse-dock-chroma.png";
}