export function Name() { return "Glorious Model D Wireless - Wired "; }
export function VendorId() { return 0x258A; }
export function ProductId() { return 0x2014; }
...
export function Render() //I need to burn and update this
{
	sendColors();
