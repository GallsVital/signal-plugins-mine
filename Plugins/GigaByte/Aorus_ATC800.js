export function Name() { return "Gigabyte Aorus ATC800"; }
export function VendorId() { return 0x1044; }
export function ProductId() { return 0x7a42; }
...
const vLedNames = ["Aorus Logo", "Ring Led 1", "Ring Led 2", "Ring Led 3", "Ring Led 4", "Ring Led 5", "Ring Led 6", "Ring Led 7", "Ring Led 8"];
...
export function Validate(endpoint) {
	return endpoint.interface === 0 && endpoint.usage === 0x0001 && endpoint.usage_page === 0xff01;
}
