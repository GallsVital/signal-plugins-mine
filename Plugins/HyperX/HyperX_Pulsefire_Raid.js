export function Name() { return "HyperX PulseFire Raid"; }
export function VendorId() { return 0x0951; }
export function ProductId() { return 0x16E4; }
...
function sendColors(shutdown = false) {
	...
	const packet = [0x07, 0x0A, color[0], color[1], color[2], col[0], col[1], col[2], 0xA0];
	device.send_report(packet, 264);
	device.pause(1);
}
