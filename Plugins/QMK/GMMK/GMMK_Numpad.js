...
const vKeyNames = [
	...
	"Left Strip 1", "Left Strip 2", "Left Strip 3", "Left Strip 4", "Left Strip 5", "Left Strip 6", "Left Strip 7",
	"Right Strip 1", "Right Strip 2", "Right Strip 3", "Right Strip 4", "Right Strip 5", "Right Strip 6", "Right Strip 7",
];
...
export function ImageUrl() {
	return "https://assets.signalrgb.com/devices/brands/glorious/keyboards/gmmk-numpad.png";
}