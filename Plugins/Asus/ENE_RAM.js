...
export function ConflictingProcesses() { return ["LightingService.exe", "XPG-Prime.exe", "LEDKeeper2.exe", "RGBFusion.exe", "ControlCenter.exe"]; }
/* global
...
class ENERam{
	constructor(Interface){
		...
		this.potentialAuraAddresses = [ 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x40, 0x4F, 0x66, 0x67, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76 ];
		this.potentialXTREEMAddresses = [ 0x39, 0x3A, 0x67, 0x70, 0x71, 0x72, 0x73, 0x75, 0x76 ];
